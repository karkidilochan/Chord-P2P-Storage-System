 ...
 */
public class GetPredecessorResponse implements Event {
    private int type;

    private String ipAddress;
    private int port;

    public GetPredecessorResponse(String ipAddress, int port) {
        this.type = Protocol.GET_PREDECESSOR_RESPONSE;
